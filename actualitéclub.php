...
<head>
    ...
    <link rel="stylesheet" href="actualitéclub.css">
...
<div class="boss">
    ...
    if($page === '1'){
        header('location: actualitéclub.php');
    ...
    $count = (int)$pdo->query("SELECT COUNT(id) FROM evenements WHERE categorie = 'club'")->fetch(PDO::FETCH_NUM)[0];
    $perPage = 9;
    ...
    $query = $pdo->query("SELECT * FROM evenements WHERE categorie = 'club' ORDER BY datecreation DESC LIMIT $offset, $perPage");
    ...
    <header class="header">
        ...
        <nav class="nav">
            ...
            <li class="li"><a href="actualitéclub.php">Club</a></li>
    ...
    <section class="lom">
        <nav class="desko">
            ...
            <li class="e"><a href="">Actualités extras</a></li>
        </nav>
    </section>
    <section class="sectionx">
        ...
        <div class="pagination">
            ...
            echo "<a href='actualitéclub.php'>1</a>&nbsp;";
