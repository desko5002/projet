...
<head>
    ...
    <link rel="stylesheet" href="actualitéextras.css">
...
<div class="boss">
    ...
    if($page === '1'){
        header('location: actualitéextras.php');
    ...
    $count = (int)$pdo->query("SELECT COUNT(id) FROM evenements WHERE categorie = 'extras'")->fetch(PDO::FETCH_NUM)[0];
    $perPage = 9;
    ...
    $query = $pdo->query("SELECT * FROM evenements WHERE categorie = 'extras' ORDER BY datecreation DESC LIMIT $offset, $perPage");
    ...
    <section class="sectionx">
        ...
        <div class="pagination">
            ...
            echo "<a href='actualitéextras.php'>1</a>&nbsp;";
