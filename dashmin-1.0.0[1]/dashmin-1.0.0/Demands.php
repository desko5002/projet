        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    <a href="blank.php" class="nav-item nav-link "><i class="fa fa-tachometer-alt me-2"></i>Bord</a>
                    ...
                    <a href="" class="nav-item nav-link active"><i class="fa fa-chart-bar me-2"></i>Demandes</a>
                    <div class="nav-item dropdown">
